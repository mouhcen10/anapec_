            ...
            <div class="d-flex flex-column rounded-0 borded bg-white shadow-sm p-2">
                ...
                <form method="POST" class="my-5" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-row justify-content-start align-items-center">
                        <label class="title ml-72" for="">Email:<span class="text-danger">*</span></label>
                        <input type="email" name="email" class="rounded-0 w-40">
                    </div>
                    <div class="d-flex flex-row justify-content-start align-items-center">
                        <label class="title ml-72" for="">Nouveau Mot de passe :<span class="text-danger">*</span></label>
                        <input type="password" name="nouveau_password" class="rounded-0 w-40">
                    </div>
                    <div class="d-flex flex-row justify-content-start align-items-center">
                        <label class="title ml-72" for="">Confirmation Nouveau Mot de passe :<span class="text-danger">*</span></label>
                        <input type="password" name="c_nouveau_password" class="rounded-0 w-40">
                    </div>
